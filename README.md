...
- ▶️ Bottom music player with Play / Pause controls
- ⌨️ Keyboard navigation highlights (accessibility)
...
🎶 Full song selection logic (play selected song)
🖼 Stable image assets
...
UI inspired by Apple Music (macOS).
